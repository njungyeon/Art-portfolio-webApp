...
function ModifyStuPage(props) {
    ...
    return (
        <div>
            <Formik
                // initialValues={{ userId: userInfo.userId, password: userInfo.password, 
                //     name: userInfo.name, classLevel: userInfo.classLevel, image: userInfo.image }}
                initialValues={{ userId: '', password: '', name: '', classLevel: '', image: '' }}
                ...
                onSubmit={(values, { setSubmitting }) => {
                    ...
                    dispatch(modifyUser(dataToSubmit))
                        .then(response => {
